/**
 * Y.AutoConfirmLoading
 * @description 车险接口化弹窗加载中组件
 * @author huya.nzb@taobao.com
 * @date 2013-03-13
 * @version 0.0.1
 */

YUI.add('autoconfirm-loading', function(Y) {

/**
 * 车险接口化弹窗加载中组件
 * @module autoconfirm-loading
 */
    ...
    var IE6 = (Y.UA.ie == 6),
        ...
        NODE_TEMPLATE = '<div class="autoconfirm-loading"><img src="http://img02.taobaocdn.com/tps/i2/T1aTaTXdBbXXXXXXXX-138-39.png" class="autoconfirm-loading-logo" /><div class="autoconfirm-loading-content"></div></div>',
        MASK_TEMPLATE = '<div class="autoconfirm-loading-mask"></div>',
        SHIM_TEMPLATE = '<iframe class="autoconfirm-loading-shim" frameborder="0" src="javascript:false" title="Step Stacking Shim" tabindex="-1" role="presentation"></iframe>';
    
    /**
     * 加载中主体结构对象
     * @class AutoConfirmLoading
     * @for AutoConfirm
     * @static
     */
    Y.AutoConfirmLoading = {
        ...
        show: function(content) {
            //默认为“正在为您呈现报价信息...”
            this._content.setContent(content || '正在为您提交信息...');
